...
@section('content')
    <div class="row">
        <table class="table">
            <tbody>
                <tr>
                    <td><h3>Nama : Matthew Reva</h3><br><h3>NIM : 03081200038</h3></td>
                    <td class="text-right">
                        <img src="{{asset('images/logo/logo.jpg')}}" alt="" style="width : 100px;">
                    </td>
                </tr>
            </tbody>
        </table>
            ...
            <div class="white_shd full margin_bottom_30">
                ...
                <div class="table_section padding_infor_info">
                    <div class="table-responsive-sm">
                        <table class="table table-bordered table-striped" id="tsc_data">
                            <thead class="dark_bg text-white">
                                <tr>
                                    <th class="font-weight-bold">#</th>
                                    <th class="font-weight-bold">User Name</th>
                                    <th class="font-weight-bold">Transaction Category</th>
                                    <th class="font-weight-bold">Transaction Details</th>
                                    <th class="font-weight-bold">Transaction Target</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($list_tsc as $tsc)
                                    <tr>
                                        ...
                                        <td>{{$tsc->tsc_amount}}</td>
                                        <td>{{$tsc->tsc_type}}</td>
                                        <td>{{$tsc->created_at}}</td>
                                    </tr>
                                    <?php $i++; ?>
                                @endforeach
                            </tbody>
